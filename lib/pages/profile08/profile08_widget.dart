...
class Profile08Widget extends StatefulWidget {
  const Profile08Widget({
    Key? key,
    String? displayName,
    String? phone,
  })  : this.displayName = displayName ?? 'display_name',
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFFB2DBF6),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          context
                                              .pushNamed('Profile16CreateEdit');
                                        },
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'ugn87y2i' /* Edit Profile */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'kro48llw' /* Notification Settings */,
                                          ),
                                          textAlign: TextAlign.start,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
