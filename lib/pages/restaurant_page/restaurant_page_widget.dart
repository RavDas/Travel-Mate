...
import 'restaurant_page_model.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final restaurantPageUsersRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
            ...
            actions: [
              ToggleIcon(
                onPressed: () async {
                  ...
                  final favoritesUpdate = restaurantPageUsersRecord.favorites
                          .contains(favoritesElement)
                      ? FieldValue.arrayRemove([favoritesElement])
                      : FieldValue.arrayUnion([favoritesElement]);
                  await restaurantPageUsersRecord.reference.update({
                    ...mapToFirestore(
                      {
                ...
                value:
                    restaurantPageUsersRecord.favorites.contains(getJsonField(
                  widget.artPiece,
                  r'''$.objectID''',
                )),
                onIcon: Icon(
