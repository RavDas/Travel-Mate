...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'RestaurantPage',
          path: '/restaurantPage',
          builder: (context, params) => RestaurantPageWidget(
            ...
            open: params.getParam('open', ParamType.String),
            ...
            location:
                params.getParam<dynamic>('location', ParamType.JSON, true),
          ),
        ),
        FFRoute(
          name: 'LoginPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => PersonalRecommendationWidget(),
        ),
        FFRoute(
          name: 'Profile16CreateEdit',
          path: '/profile16CreateEdit',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Profile16CreateEdit')
              : Profile16CreateEditWidget(),
        ),
        FFRoute(
          name: 'Profile08',
          path: '/profile08',
        ...
        FFRoute(
          name: 'Sites',
          path: '/sites',
          builder: (context, params) => SitesWidget(
